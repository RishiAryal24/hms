...
export const getIPDVitals = (admissionId) => api.get(`/inpatient/admissions/${admissionId}/vitals/`);
export const createIPDVital = (admissionId, data) => api.post(`/inpatient/admissions/${admissionId}/vitals/`, data);
